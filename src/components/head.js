    ...
    render() {
        return (
            <>
                ...
                {
                    (this.props.cssImports ? this.props.cssImports : [])
                    .map((element, key) => {
                        return (
                ...
                {
                    this.props.jsonLD ? <Head key={`jsonld-data`}>
                        <script type={`application/ld+json`} dangerouslySetInnerHTML={{__html: this.props.jsonLD}}></script>
                    </Head> : <></>
                }
            </>
        )
