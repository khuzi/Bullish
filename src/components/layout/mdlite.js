...
export default function MDLiteLayout(props) {
  ...
  return (
    <div
      className={`mdl-layout mdl-js-layout color--gray is-small-screen mdl-layout--fixed-header ${className}`}
      style={{ height: "100vh" }}
    >
      <Helmet>
        <link
          href="https://fonts.googleapis.com/css?family=Roboto:400,500,300,100,600,700,900"
          rel="stylesheet"
          type="text/css"
        />
        <link
