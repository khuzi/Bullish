      ...
      <nav className="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
        ...
        <ul className="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
          <li className="nav-item mx-1">
            <a
              className="nav-link"
              href="https://askbootstrap.com/preview/vidoe-v2-3/upload.html"
            >
          ...
          <li className="nav-item dropdown no-arrow osahan-right-navbar-user">
            ...
            >
              <a
                className="dropdown-item"
                href="https://askbootstrap.com/preview/vidoe-v2-3/account.html"
              >
                <i className="fas fa-fw fa-user-circle"></i> &nbsp; My Account
              </a>
              <a
                className="dropdown-item"
                href="https://askbootstrap.com/preview/vidoe-v2-3/subscriptions.html"
              >
                <i className="fas fa-fw fa-video"></i> &nbsp; Subscriptions
              </a>
              <a
                className="dropdown-item"
                href="https://askbootstrap.com/preview/vidoe-v2-3/settings.html"
              >
