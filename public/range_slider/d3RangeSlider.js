function createD3RangeSlider(rangeMin, rangeMax, containerSelector, playButton, itemsToDisplay) {
    //"use strict";
    ...
    var labelW = slider.append("div").attr("class", "label WW");
    var labelE = slider.append("div").attr("class", "label EE");
    ...
    function updateLabels(begin, end){
        const beginText = itemsToDisplay[begin];
        const endText = itemsToDisplay[end];
        if(!endText){
            console.log({itemsToDisplay, end})
        }

        labelW._groups[0][0].innerHTML = beginText;
        labelW._groups[0][0].style.left = ((labelW._groups[0][0].offsetWidth + 5)*-1)+"px";
        labelE._groups[0][0].innerHTML = endText;
        labelE._groups[0][0].style.right = ((labelE._groups[0][0].offsetWidth + 5)*-1)+"px";
    }
    ...
    function updateRangeFromUI () {
        ...
        //Update labels
        updateLabels(sliderRange.begin, sliderRange.end);
